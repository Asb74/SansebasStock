...
import '../features/tools/pallet_groups/desagrupar_boxes_screen.dart';
  ...
  routes: <RouteBase>[
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: 'desagrupar-boxes',
          name: 'tools-desagrupar-boxes',
          builder: (BuildContext context, GoRouterState state) =>
              const DesagruparBoxesScreen(),
        ),
        GoRoute(
          path: 'assign-storage',
          ...
          routes: [
            GoRoute(
              ...
              builder: (BuildContext context, GoRouterState state) {
                ...
                if (camera is CameraModel) {
                  return AssignStorageRowsScreen(camera: camera);
                }
                return AssignStorageRowsLoader(cameraId: cameraId);
              },
            ),
          ],
        ),
